...
def main():
    ...
    # Save the input and output images to temporary files
    input_image_path = "input_image.jpg"
    interpolated_image_path = "interpolated_image.jpg"
    image.save(input_image_path)
    interpolated_image.save(interpolated_image_path)

    # Calculate the file sizes
    input_file_size = os.path.getsize(input_image_path)
    interpolated_file_size = os.path.getsize(interpolated_image_path)

    # Print the file size difference
    size_difference = interpolated_file_size - input_file_size
    print("Difference in file size: {} bytes".format(size_difference))
    ...
    os.remove(interpolated_image_path)
