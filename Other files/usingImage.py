        ...
        for x in range(width):
            ...
            for c in range(3):  # Iterate over RGB channels
                ...
                for i in range(len(control_points)):
                    weighted_sum += basis_functions_x[i] * basis_functions_y[i] * pixel_values[control_points[i][1], control_points[i][0], c]
...
def main():
    image_path = '/Users/bibhushansaakha/Desktop/Work/Academic/Cubic-B-Spline-Interpolation/team.jpeg'
