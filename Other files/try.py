        ...
        for x in range(width):
            ...
            for c in range(3):  # Iterate over RGB channels
                ...
                for i in range(len(control_points)):
                    control_point_x = control_points[i][0]
                    control_point_y = control_points[i][1]
                    weighted_sum += basis_functions_x[i] * basis_functions_y[i] * pixel_values[control_point_y, control_point_x, c]
...
def main():
    ...
    control_points = np.array([[0, 0], [0, 2], [0, 4], [1, 1], [1, 3], [2, 2], [3, 1], [3, 3], [4, 0], [4, 2], [4, 4]])
