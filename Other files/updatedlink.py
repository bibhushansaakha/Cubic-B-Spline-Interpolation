        ...
        for x in range(width):
            ...
            for c in range(3):  # Iterate over RGB channels
                ...
                for i in range(len(control_points)):
                    basis_x = basis_functions_x[i]
                    basis_y = basis_functions_y[i]
                    control_point_x, control_point_y = control_points[i]

                    weighted_sum += basis_x * basis_y * pixel_values[control_point_y, control_point_x, c]
...
def evaluate_basis_functions(knot_vector, degree, t):
    basis_functions = []
    num_control_points = len(knot_vector) - degree - 1
